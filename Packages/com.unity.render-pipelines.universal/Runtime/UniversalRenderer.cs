...
namespace UnityEngine.Rendering.Universal
{
    ...
    public sealed class UniversalRenderer : ScriptableRenderer
    {
        ...
        bool RequiresIntermediateColorTexture(ref CameraData cameraData)
        {
			...
			bool isScaledRender = cameraData.imageScaling != ImageScaling.None; // This is in fsr-merged
			//bool isScaledRender = !Mathf.Approximately(cameraData.renderScale, 1.0f); // This was in master
			//bool isScaledRender = false;// !Mathf.Approximately(cameraData.renderScale, 1.0f); // This was in trunkasw
