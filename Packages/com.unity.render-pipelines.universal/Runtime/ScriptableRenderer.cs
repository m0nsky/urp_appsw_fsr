            ...
            else
            {
                ...
                else
                {
                        ...
                        renderPass.colorStoreActions[0] != m_ActiveColorStoreActions[0] || renderPass.depthStoreAction != m_ActiveDepthStoreAction)
                    {
                        ...
                        if (cameraData.xr.enabled)
                        {
                            bool isMotionVec = renderPass is Internal.MotionVecPass;
                            ...
                            bool isRenderToBackBufferTarget = (passColorAttachment.nameID == cameraData.xr.renderTarget && !cameraData.xr.renderTargetIsRenderTexture) ||
                                (passColorAttachment.nameID == cameraData.xr.motionVectorRenderTarget && !cameraData.xr.motionVectorRenderTargetIsRenderTexture);
                            cameraData.xr.UpdateGPUViewAndProjectionMatrices(cmd, ref cameraData, !isRenderToBackBufferTarget, isMotionVec);
                        }
#endif
                    }
                }
