...
namespace UnityEngine.Rendering.Universal
{
    ...
    internal struct XRView
    {
        ...
        internal XRView(XRDisplaySubsystem.XRRenderPass renderPass, XRDisplaySubsystem.XRRenderParameter renderParameter)
        {
            ...
            prevViewValid = false;
            prevViewMatrix = Matrix4x4.identity;
            //prevViewValid = renderParameter.prevViewValid;
            //if (renderParameter.prevViewValid)
            //{
            //    Debug.Log("On this frame, renderParameter.view is " + viewMatrix.ToString() + " and renderParameters.prevView is " + renderParameter.prevView.ToString());
            //}
            //prevViewMatrix = (prevViewValid) ? renderParameter.prevView : Matrix4x4.identity;
    ...
    class XRPass
    {
        ...
        internal void UpdateGPUViewAndProjectionMatrices(CommandBuffer cmd, ref CameraData cameraData, bool isRenderToTexture, bool isMotionVec = false)
        {
            ...
            if (cameraData.xr.singlePassEnabled)
            {
                ...
                RenderingUtils.SetStereoViewAndProjectionMatrices(cmd, stereoViewMatrix, stereoProjectionMatrix, stereoCameraProjectionMatrix, true, prevViewValid, stereoPrevViewMatrix, isMotionVec);
